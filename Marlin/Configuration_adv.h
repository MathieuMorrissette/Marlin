 ...
 */
#define FAN_KICKSTART_TIME 1000 // (ms) // MATMO
#define FAN_KICKSTART_POWER 180  // 64-255 // MATMO
...
#define QUICK_HOME // MATMO                            // If G28 contains XY do a diagonal move first
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 200 // MATMO
   ...
   */
  #define BLTOUCH_HS_MODE true // MATMO
...
//#define ASSISTED_TRAMMING
   ...
   */
  #define TRAMMING_SCREW_THREAD 40 // BTT
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_SCROLLING // BTT 
...
#define SET_PROGRESS_MANUALLY // BTT
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  //#define SET_REMAINING_TIME      // BTT      // Add 'R' parameter to set remaining time
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  // SD Card Sorting options
    ...
    #define SDSORT_USES_RAM    true // BTT  // Pre-allocate a static array for faster pre-sorting.
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true // BTT // Keep sorted items in RAM longer for speedy performance. Most expensive option.
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // BTT  // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT  // BTT  // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         // BTT  // Scroll long filenames in the SD card menu
   ...
   */
  #define SDCARD_CONNECTION ONBOARD // BTT
...
#define BABYSTEPPING // MATMO
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // MATMO  // Double-click on the Status Screen for Z Babystepping.
 ...
 */
#define LIN_ADVANCE // MATMO
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.08 }   // MATMO printing mostly petg https://help.prusa3d.com/article/linear-advance_2252 // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.08   // MATMO      // (mm) Compression length applying to all extruders
  #endif
...
// G2/G3 Arc Support
//
//#define ARC_SUPPORT  // BTT               // Requires ~3226 bytes
 ...
 */
#define ADVANCED_PAUSE_FEATURE // MATMO
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      100 // MATMO  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   100 // MATMO  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  #define ADVANCED_PAUSE_CONTINUOUS_PURGE     // MATMO  // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH        100  // MATMO (mm) Length to extrude after loading.
  ...
  #define PARK_HEAD_ON_PAUSE   // MATMO                   // Park the nozzle during pause and filament change.
  // #define HOME_BEFORE_FILAMENT_CHANGE   // MATMO            // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES // MATMO           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  (X_CURRENT/2)  //BTT // (mA) RMS current for sensorless homing
    ...
    #define Y_CURRENT_HOME  (Y_CURRENT/2) // BTT
    ...
    #define Z_CURRENT       1200 // MATMO - Dual Z-Axis
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V   // BTT     // All axes (override below)
   ...
   */
  #define HYBRID_THRESHOLD // MATMO - The intent is that when the axis needs more torque (such as when trying to move faster) it will have access to it, but will otherwise remain in "silent" mode.  
   ...
   */
  #define EDGE_STEPPING // MATMO/BTT
 ...
 */
#define HOST_ACTION_COMMANDS  // MATMO 
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76          // MATMO        // Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT       // MATMO      // Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    //#define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM      // MATMO      // Add a menu item that tells the host to start
  #define HOST_SHUTDOWN_MENU_ITEM    // MATMO     // Add a menu item that tells the host to shut down
#endif
 ...
 * @section calibrate
 */
#define MECHANICAL_GANTRY_CALIBRATION // MATMO 
