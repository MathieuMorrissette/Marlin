...
#define STRING_CONFIG_H_AUTHOR "(matmo, Ender-3)" // MATMO // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V2_0 // BTT
#endif
...
#define X_DRIVER_TYPE  TMC2209 // BTT
#define Y_DRIVER_TYPE  TMC2209 // BTT
#define Z_DRIVER_TYPE  TMC2209 // BTT
...
#define E0_DRIVER_TYPE TMC2209 // BTT
...
#define BED_MAXTEMP      125 // MATMO - PREVENT OVERHEATING BED
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  34.35 // MATMO - Calibration
    #define DEFAULT_Ki   3.86 // MATMO - Calibration
    #define DEFAULT_Kd  76.43 // MATMO - Calibration
  #endif
#else
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 50.71 // BTT
  #define DEFAULT_bedKi 9.88 // BTT
  #define DEFAULT_bedKd 173.43 // BTT
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 136.4 } // MATMO
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } // MATMO
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 5000 } // MATMO
 ...
 */
#define DEFAULT_ACCELERATION          500 // MATMO    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  500 // MATMO   // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   500 // MATMO    // X, Y, Z acceleration for travel (non printing) moves
 ...
 */
#define S_CURVE_ACCELERATION // MATMO
...
#define USE_PROBE_FOR_Z_HOMING // MATMO
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -2.44 } // MATMO
...
#define XY_PROBE_FEEDRATE (200*60) // MATMO
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // MATMO
...
// Ender 3 bed size is 235x235 but i leave 5mm margin for clips holding the glass // MATMO
#define X_BED_SIZE 225 // MATMO
#define Y_BED_SIZE 225  // MATMO

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -8 // 3mm outside + 5mm padding // MATMO
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 20) // X can travel further useful for bltouch probe // MATMO
#define Y_MAX_POS (Y_BED_SIZE)  // MATMO
#define Z_MAX_POS 250 // MATMO
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // MATMO
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 350 // MATMO
...
#define AUTO_BED_LEVELING_UBL // MATMO
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 // MATMO
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION // MATMO
  ...
  #define GRID_MAX_POINTS_X 5 // MATMO
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID // MATMO
  ...
  #define MESH_EDIT_GFX_OVERLAY // MATMO  // Display a graphics overlay while editing the mesh

  #define MESH_INSET 10 // MATMO          // Set Mesh bounds as an inset region of the bed
...
#define HOMING_FEEDRATE_MM_M { (20*60), (20*60), (4*60) } // MATMO
 ...
 */
#define EEPROM_SETTINGS   // BTT    // Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save PROGMEM.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT // BTT   // Init EEPROM automatically on any errors.
 ...
 */
#define NOZZLE_PARK_FEATURE // MATMO
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN // MATMO
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // MATMO
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2  // MATMO
#define LCD_FEEDBACK_FREQUENCY_HZ 3000  // MATMO
...
// :[0,1,2,3,4,5,6,7]
#define SOFT_PWM_SCALE 1  // MATMO
 
// If SOFT_PWM_SCALE is set to a value higher than 0, dithering can
// be used to mitigate the associated resolution loss. If enabled,
// some of the PWM cycles are stretched so on average the desired
// duty cycle is attained.
#define SOFT_PWM_DITHER  // MATMO
